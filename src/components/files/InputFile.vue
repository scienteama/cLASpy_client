  ...
  <div class="q-pa-md items-start q-gutter-y-md" style="width: auto; min-width: 70%">
    <q-file :model-value="file" @update:model-value="updateFile" label="Uploader un fichier" outlined :clearable="!fileUploadProgress.uploading">
      ...
      <template #after v-if="canUpload">
        <q-btn v-if="!fileUploadProgress.uploading" color="primary" dense icon="cloud_upload" round @click="upload" :disable="!canUpload" :loading="fileUploadProgress.uploading" />
